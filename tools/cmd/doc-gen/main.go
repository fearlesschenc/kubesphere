...
import (
	...
	iamv1alpha2 "github.com/fearlesschenc/kubesphere/pkg/kapis/iam/v1alpha2"
	...
	resourcesv1alpha3 "github.com/fearlesschenc/kubesphere/pkg/kapis/resources/v1alpha3"
	metricsv1alpha2 "github.com/fearlesschenc/kubesphere/pkg/kapis/servicemesh/metrics/v1alpha2"
...
func generateSwaggerJson() []byte {
	...
	urlruntime.Must(monitoringv1alpha3.AddToContainer(container, nil))
