...
func schema_pkg_apis_devops_v1alpha1_ContainerInfo(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"runtimeArtifacts": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.VolumeSpec"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.VolumeSpec"},
	}
}
...
func schema_pkg_apis_devops_v1alpha1_DockerConfigJson(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"auths": {
						SchemaProps: spec.SchemaProps{
							...
							AdditionalProperties: &spec.SchemaOrBool{
								...
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.DockerConfigEntry"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.DockerConfigEntry"},
	}
}
...
func schema_pkg_apis_devops_v1alpha1_S2iBinary(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBinarySpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBinaryStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBinarySpec", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBinaryStatus"},
	}
}
...
func schema_pkg_apis_devops_v1alpha1_S2iBinaryList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBinary"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBinary"},
	}
}
...
func schema_pkg_apis_devops_v1alpha1_S2iBuilder(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBuilderSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBuilderStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBuilderSpec", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBuilderStatus"},
	}
}
...
func schema_pkg_apis_devops_v1alpha1_S2iBuilderList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBuilder"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBuilder"},
	}
}
...
func schema_pkg_apis_devops_v1alpha1_S2iBuilderSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					"config": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iConfig"),
						},
					},
					"fromTemplate": {
						SchemaProps: spec.SchemaProps{
							Description: "FromTemplate define some inputs from user",
							Ref:         ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.UserDefineTemplate"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iConfig", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.UserDefineTemplate"},
	}
}
...
func schema_pkg_apis_devops_v1alpha1_S2iBuilderTemplate(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBuilderTemplateSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBuilderTemplateStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBuilderTemplateSpec", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBuilderTemplateStatus"},
	}
}
...
func schema_pkg_apis_devops_v1alpha1_S2iBuilderTemplateList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBuilderTemplate"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBuilderTemplate"},
	}
}
...
func schema_pkg_apis_devops_v1alpha1_S2iBuilderTemplateSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"containerInfo": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.ContainerInfo"),
									},
								},
							},
						},
					...
					"environment": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.Parameter"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.ContainerInfo", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.Parameter"},
	}
}
...
func schema_pkg_apis_devops_v1alpha1_S2iConfig(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"runtimeAuthentication": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.AuthConfig"),
						},
					},
					"runtimeArtifacts": {
						SchemaProps: spec.SchemaProps{
					...
					"dockerConfig": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.DockerConfig"),
						},
					},
					"pullAuthentication": {
						SchemaProps: spec.SchemaProps{
					...
					"environment": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.EnvironmentSpec"),
									},
								},
							},
						},
					...
					"cgroupLimits": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.CGroupLimits"),
						},
					},
					"dropCapabilities": {
						SchemaProps: spec.SchemaProps{
					...
					"scriptDownloadProxyConfig": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.ProxyConfig"),
						},
					},
					"excludeRegExp": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.LocalObjectReference", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.AuthConfig", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.CGroupLimits", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.DockerConfig", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.EnvironmentSpec", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.ProxyConfig", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.VolumeSpec"},
	}
}
...
func schema_pkg_apis_devops_v1alpha1_S2iRun(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iRunSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iRunStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iRunSpec", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iRunStatus"},
	}
}
...
func schema_pkg_apis_devops_v1alpha1_S2iRunList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iRun"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iRun"},
	}
}
...
func schema_pkg_apis_devops_v1alpha1_S2iRunStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"s2iBuildResult": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBuildResult"),
						},
					},
					"s2iBuildSource": {
						SchemaProps: spec.SchemaProps{
							Description: "S2i build source info.",
							Ref:         ref("github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBuildSource"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.Time", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBuildResult", "github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.S2iBuildSource"},
	}
}
...
func schema_pkg_apis_devops_v1alpha1_UserDefineTemplate(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/fearlesschenc/kubesphere/pkg/apis/devops/v1alpha1.Parameter"},
	}
}
