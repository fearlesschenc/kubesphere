...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NamespaceNetworkPolicy":     schema_pkg_apis_network_v1alpha1_NamespaceNetworkPolicy(ref),
		"github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NamespaceNetworkPolicyList": schema_pkg_apis_network_v1alpha1_NamespaceNetworkPolicyList(ref),
		"github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NamespaceNetworkPolicySpec": schema_pkg_apis_network_v1alpha1_NamespaceNetworkPolicySpec(ref),
		"github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NamespaceSelector":          schema_pkg_apis_network_v1alpha1_NamespaceSelector(ref),
		"github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NetworkPolicyEgressRule":    schema_pkg_apis_network_v1alpha1_NetworkPolicyEgressRule(ref),
		"github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NetworkPolicyIngressRule":   schema_pkg_apis_network_v1alpha1_NetworkPolicyIngressRule(ref),
		"github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NetworkPolicyPeer":          schema_pkg_apis_network_v1alpha1_NetworkPolicyPeer(ref),
		"github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.ServiceSelector":            schema_pkg_apis_network_v1alpha1_ServiceSelector(ref),
	}
}
...
func schema_pkg_apis_network_v1alpha1_NamespaceNetworkPolicy(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NamespaceNetworkPolicySpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NamespaceNetworkPolicySpec"},
	}
}
...
func schema_pkg_apis_network_v1alpha1_NamespaceNetworkPolicyList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NamespaceNetworkPolicy"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NamespaceNetworkPolicy"},
	}
}
...
func schema_pkg_apis_network_v1alpha1_NamespaceNetworkPolicySpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"ingress": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NetworkPolicyIngressRule"),
									},
								},
							},
						},
					...
					"egress": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NetworkPolicyEgressRule"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NetworkPolicyEgressRule", "github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NetworkPolicyIngressRule"},
	}
}
...
func schema_pkg_apis_network_v1alpha1_NetworkPolicyEgressRule(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"to": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NetworkPolicyPeer"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/api/networking/v1.NetworkPolicyPort", "github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NetworkPolicyPeer"},
	}
}
...
func schema_pkg_apis_network_v1alpha1_NetworkPolicyPeer(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"namespace": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NamespaceSelector"),
						},
					},
					"ipBlock": {
						SchemaProps: spec.SchemaProps{
					...
					"service": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.ServiceSelector"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/api/networking/v1.IPBlock", "github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.NamespaceSelector", "github.com/fearlesschenc/kubesphere/pkg/apis/network/v1alpha1.ServiceSelector"},
	}
}
