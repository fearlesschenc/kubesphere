...
import (
	...
	audit "github.com/fearlesschenc/kubesphere/pkg/apiserver/auditing"
	"github.com/fearlesschenc/kubesphere/pkg/apiserver/authentication/authenticators/basic"
	"github.com/fearlesschenc/kubesphere/pkg/apiserver/authentication/authenticators/jwttoken"
	"github.com/fearlesschenc/kubesphere/pkg/apiserver/authentication/request/anonymous"
	"github.com/fearlesschenc/kubesphere/pkg/apiserver/authentication/request/basictoken"
	"github.com/fearlesschenc/kubesphere/pkg/apiserver/authentication/request/bearertoken"
	"github.com/fearlesschenc/kubesphere/pkg/apiserver/authorization/authorizer"
	"github.com/fearlesschenc/kubesphere/pkg/apiserver/authorization/authorizerfactory"
	authorizationoptions "github.com/fearlesschenc/kubesphere/pkg/apiserver/authorization/options"
	"github.com/fearlesschenc/kubesphere/pkg/apiserver/authorization/path"
	unionauthorizer "github.com/fearlesschenc/kubesphere/pkg/apiserver/authorization/union"
	...
	"github.com/fearlesschenc/kubesphere/pkg/apiserver/filters"
	"github.com/fearlesschenc/kubesphere/pkg/apiserver/request"
	"github.com/fearlesschenc/kubesphere/pkg/informers"
	alertingv1 "github.com/fearlesschenc/kubesphere/pkg/kapis/alerting/v1"
	clusterkapisv1alpha1 "github.com/fearlesschenc/kubesphere/pkg/kapis/cluster/v1alpha1"
	configv1alpha2 "github.com/fearlesschenc/kubesphere/pkg/kapis/config/v1alpha2"
	devopsv1alpha2 "github.com/fearlesschenc/kubesphere/pkg/kapis/devops/v1alpha2"
	devopsv1alpha3 "github.com/fearlesschenc/kubesphere/pkg/kapis/devops/v1alpha3"
	iamapi "github.com/fearlesschenc/kubesphere/pkg/kapis/iam/v1alpha2"
	monitoringv1alpha3 "github.com/fearlesschenc/kubesphere/pkg/kapis/monitoring/v1alpha3"
	networkv1alpha2 "github.com/fearlesschenc/kubesphere/pkg/kapis/network/v1alpha2"
	notificationv1 "github.com/fearlesschenc/kubesphere/pkg/kapis/notification/v1"
	"github.com/fearlesschenc/kubesphere/pkg/kapis/oauth"
	openpitrixv1 "github.com/fearlesschenc/kubesphere/pkg/kapis/openpitrix/v1"
	operationsv1alpha2 "github.com/fearlesschenc/kubesphere/pkg/kapis/operations/v1alpha2"
	resourcesv1alpha2 "github.com/fearlesschenc/kubesphere/pkg/kapis/resources/v1alpha2"
	resourcev1alpha3 "github.com/fearlesschenc/kubesphere/pkg/kapis/resources/v1alpha3"
	servicemeshv1alpha2 "github.com/fearlesschenc/kubesphere/pkg/kapis/servicemesh/metrics/v1alpha2"
	tenantv1alpha2 "github.com/fearlesschenc/kubesphere/pkg/kapis/tenant/v1alpha2"
	terminalv1alpha2 "github.com/fearlesschenc/kubesphere/pkg/kapis/terminal/v1alpha2"
	"github.com/fearlesschenc/kubesphere/pkg/kapis/version"
...
func (s *APIServer) installKubeSphereAPIs() {
	...
	urlruntime.Must(monitoringv1alpha3.AddToContainer(s.container, s.MonitoringClient))
